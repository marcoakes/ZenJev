...
const binding:ApprovalBinding={actionId:'a1',ticketId:'1',ticketVersion:1,ticketSnapshotId:'s1',decisionId:'d1',decisionVersion:1,destination:'example/integrations',dataSource:'synthetic',provider:'mock',mode:'dry_run',kind:'create_issue',target:{provider:'github',host:'github.com',project:'example/integrations'},payload:{title:'Webhook retries stop',body:'Public evidence'}};
