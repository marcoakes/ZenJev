...
export type IssueView = { id: string; number: string; title: string; repository: string; state: string; provider?: string; host?: string; url?: string | null; tickets?: TicketView[]; organizationCount?: number; ticketCount?: number; proposedTeam?: string };
...
export type ActionView = { id: string; ticketId: string; type: string; destination: string; issueProvider?: string | null; issueHost?: string | null; payload: JsonObject & { title?: string; body?: string }; mode: string; state: string; provider: string; dataSource: string; ticketVersion: number; decisionId: string; payloadHash: string; receipt?: JsonObject | null; error?: string | null; approvals?: JsonObject[]; attempts?: JsonObject[] };
export type SettingsView = { dataMode: string; jevMode: string; allowLiveWrites: boolean; allowLiveDataProcessing: boolean; includeInternalNotes: boolean; threshold: number; policyThresholds: PolicyThresholds; teamCriteria: Record<string,string>; repositories: string[]; teamMappings: Record<string,string|null>; rubricVersion: string; replayState: string; retentionDays: number; connections?: Record<string,string>; issueProvider?: string; issueHost?: string; issueHostError?: string | null; issueCredentialState?: string; csrfToken?: string };
